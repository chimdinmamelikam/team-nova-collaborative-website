# SweetCrumbs Collaborative Website

This project was built collaboratively by a team of students to practice HTML, CSS, Git, and GitHub collaboration while creating a multi-page bakery website. 

This project showcases a fictional bakery website designed with consistency, creativity, and teamwork in mind.

⭐ About Team Nova

Team Nova is a dedicated group of five emerging frontend developers working collaboratively to build a fully functional website, practicing industry-standard Git and GitHub workflows.

We believe that great outcomes come from seamless teamwork.
Our collaboration is rooted in:
...
Maintaining unified styling and layout

Clear communication through every development stage
...
- Shared navigation bar for smooth user experience
- Clean UI with consistent styling
- Bakery-specific services section with cards, badges and call-to-actions
- How-it-works section to guide users through ordering
- Testimonials section showcasing client reviews
- Additional information section with clear CTAs
...
Ensures design guidelines are followed across all pages

Maintains consistent global styling

Guides the team through Git branching, PR creation, and merging workflows
...
A well-organized team section

A clean, functional user-friendly contact form
